...
class SiteSettings(BaseSiteSetting):
    ...
    panels = [
        ...
        MultiFieldPanel([FieldPanel("phone"), FieldPanel("whatsapp_number"), FieldPanel("email"), FieldPanel("instagram_url"), FieldPanel("address"), FieldPanel("google_maps_url")], "Contact"),
        MultiFieldPanel([FieldPanel("seo_title"), FieldPanel("seo_description")], "SEO"),
        MultiFieldPanel([FieldPanel("nav_experience"), FieldPanel("nav_facilities"), FieldPanel("nav_nearby"), FieldPanel("nav_blog"), FieldPanel("nav_gallery"), FieldPanel("nav_contact"), FieldPanel("reservation_cta_label")], "Navigation"),
